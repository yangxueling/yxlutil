package com.yxlisv.util.codebuild.control;
...
public class ControlBuilder extends CodeBuilder{
	...
	public void build(){
		...
		for(Iterator it=packages.iterator(); it.hasNext();){
			...
			sb.append("import com.yxlisv.util.date.DateUtil;\n");
			sb.append("import com.yxlisv.util.Page;\n");
			sb.append("import com.yxlisv.util.exception.SimpleMessageException;\n");
			sb.append("import com.yxlisv.util.security.radom.WebRadomUtil;\n\n");
